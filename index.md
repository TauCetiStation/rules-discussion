...
3. Стримснайпинг (stream sniping) - смотреть стримы игроков (см. п.5), играющих на любом из серверов Tau Ceti в тот момент, когда вы сами играете на этом сервере, запрещено (см. п.3).
