...
1. Придерживайтесь норм общения  
   ...
   - Не стоит оскорблять других участников сообщества  
      - Под это правило подпадает эскалация спора с переходом на личности. Пишите взвешенно и аргументированно.  
   - Уважайте других участников сообщества. В том числе и новичков. Они, вполне вероятно, могут огорчить вас даже не желая этого. Проявите понимание.  
   - Спам запрещен.  
...
3. Метагейминг (metagame) - использование информации, полученной неигровым путем (Из любого OOC источника), для получения каких-либо игровых преимуществ серьезно вредит игровой атмосфере и потому запрещено. Сюда относится игра с использованием сторонних чатов (голосовых или текстовых) для кооперации действий. Никто не будет устраивать охоту на ведьм, но когда один персонаж бежит через пол станции чтобы спасти другого, при этом не имея ни малейшей возможности узнать о происходящем там - все и так понятно.  
   - Есть, однако, небольшое исключение. Если вам хочется показать кому-то из своих знакомых эту игру, при этом попутно объясняя происходящее - обратитесь к администраторам. Это вполне допустимо.
    - Помимо этого, стоит учитывать некоторые игровые условности касательно доступности информации. К примеру, по умолчанию, большинство информации об антагонистах считается неизвестной для экипажа. Подробнее можно посмотреть в данной статье на вики [link]  
   
4. Распространение любой информации о текущем раунде посредством любых OOC средств запрещено. Сюда попадает как игровой OOC канал, так и любые сторонние форумы/чаты. Информация и ее распространение в игре является одним их тех элементов, что делает многие раунды интересными. Внезапные предательства, обман, блеф и прочее. А потому, преждевременное ее обсуждение вне, собственно, раунда - очень часто может повлиять на всех участников.  
   - Если у вас возникли какие-то проблемы с механикой - напишите менторам (кнопка F9) если вы считаете, что обнаружили баг - напишите Администраторам (F1), если вы уверены что нашли баг - можете написать о нем сразу на гитхаб. Если вы считаете что кто-то делает что-то не-так, можете попробовать написать ему в LOOC (локальный ооц чат, который отображается только у администраторов и тех, кто находится в данный момент рядом с вами), либо попросить Администратора подсказать человеку в чем он не прав.  
   - Написание жалоб на форум или в дискорд так же стоит отложить до окончания раунда.  
...
1. Ступиднейм - имя, нарушающее пункт 5 общих правил. Это может быть имя какой-то известной личности, имя с  добавлением туда непонятных “кличек”, либо просто что-то достаточно глупое. Рекомендуется избегать подобных имен. В случае, если вам очень хочется как-то назвать своего персонажа, но у вас есть сомнения, - обратитесь к Администратору.   
   ...
   - В случае нарушения данного правила администрация оставляет за собой право принудительно переименать вашего персонажа по своему усмотрению.   
...
1. Офицер службы безопасности - дисциплинированный боец, который прошел тщательный отбор. Они являются первым и последним рубежом защиты станции, а главным образом является той силой, которая призвана для поддержания внутреннего порядка на борту станции и сохранению корпоративных интересов, в лице служению их законным представителям, то бишь главам.   
   -   Соблюдайте иерархию приказов [link]. Постарайтесь максимально ответственно отнестись к выполнению поставленных вам задач.   
2. Первоочередной вашей задачей является поддержание порядка и решение игровых конфликтов игровыми же методами.   
   ...
   - Соблюдайте протоколы космического закона [link] и внутренний порядок действий, когда это возможно.  
